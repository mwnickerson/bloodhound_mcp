...
class TestDomainMCPTools:
    ...
    @patch('main.bloodhound_api')  # Mock the specific bloodhound_api instance in main.py
    ...
    def test_get_domains_error_handling(self, mock_api):
        ...
        mock_api.domains.get_all.side_effect = Exception("BloodHound server unreachable")
    ...
    def test_get_users_from_domain(self, mock_api):
        ...
        mock_api.domains.get_users.assert_called_once_with(
            domain_id, limit=100, skip=0
        )
...
class TestManualFunctionTesting:
    ...
    def test_json_response_format(self):
        ...
        fake_domains = [
            {"objectid": "domain1", "name": "TEST.LOCAL", "type": "Domain"}
        ]
    ...
    def test_error_response_format(self):
        ...
        error_response = {
            "error": "Failed to retrieve domains: Connection timeout"
        }
...
class TestDiagnostics:
    ...
    def test_check_mcp_functions_exist(self):
        ...
        """
        expected_functions = [
            'get_domains', 'get_users', 'get_groups', 'search_objects',
            'get_user_info', 'get_user_admin_rights', 'run_cypher_query'
        ]
